...
exports.resetForgotPassword = async (req, res, next) => {
  try {
    ...
    const path = `http://13.51.79.59:3000/password/resetpassword/${id}`;
          ...
          <div class="container d-flex flex-column p-4 pb-0" style="max-width: 650px">
            ...
            <p id="loginNow" style="display: none">
              ...
              <a
                ...
                href="http://13.51.79.59:3000/login/login.html"
                >Login Now</a
              >
                ...
                if (pass.value !== confirmPass.value) {
                  ...
                  try {
                    const response = await axios.post(
                      "http://13.51.79.59:3000/password/resetpassword/${req.params.id}",
